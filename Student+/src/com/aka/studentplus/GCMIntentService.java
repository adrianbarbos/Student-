...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        Log.d("NAME", TnlDrawerLayout.name);
        aController.register(context, TnlDrawerLayout.name, TnlDrawerLayout.email, registrationId);
    }
	...
	private static void generateNotification(Context context, String message) {
        ...
        Intent notificationIntent = new Intent(context, TnlDrawerLayout.class);
   ...
   /* public void startNotification(Context context, String message) {
        // TODO Auto-generated method stub
        //Creating Notification Builder
           notification = new NotificationCompat.Builder(GCMIntentService.this);
           //Title for Notification
           notification.setContentTitle("CSL");
           //Message in the Notification
           notification.setContentText(message);
           //Alert shown when Notification is received
           notification.setTicker("Mesaj nou CSL!");
           //Icon to be set on Notification
           notification.setSmallIcon(R.drawable.ic_launcher);
           notification.setVibrate(LongBuffer);
